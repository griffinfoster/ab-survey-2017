...
We then looked at previous recorded events close in time to the event.
...
statistial measure can be made on any time window to differentiate times of
...
cheap as the time window is decimated, reducing the memory usage. Full sampling
