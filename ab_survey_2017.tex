...
detection of an interesting Galactic radio transient with a DM of 281 pc cm$^{-3}$, 
...
% comment on non-detection in regards to the Cordes et al plasma lens
...
% Possible reasons for non-detection: star formation rate, scintillation, steep spectrum
%   * Star formation rate:
