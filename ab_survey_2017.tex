...
%pulses are often excised.
% low dm pulsars (examples) have flux clipped out but a portion remains and the
% pulsar is regularlly detected

% some FRBs will be partially clipped, but still detected with significance
%Our pipeline would preserve the flux of all
...
%is \gls{dm} $=976$~pc~cm$^{-3}$. Higher DM pulses 
...
% TODO: should we expand on these 8 categories???
...
% TODO: reference to relevant papers?
...
% 
% I would suggest that the calculation be done just once in the text, and not as
% it is done now with and without thinking about sidelobes. I guess what I mean is
% to just do it assuming the sidelobes and quote the numbers from that.
% 
...
% TODO: I suggest clearly adopting an all-sky event rate
