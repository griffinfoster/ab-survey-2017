...
FRB~150807 and FRB~170827 would be significantly clipped by the exciser. But, the
...
observing frequency, these event windows are labelled as class 5 events. Class 7 and 8 are due
...
for training. Before training, the features of the labelled data sets were median
...
stratified k-fold **What is this??? Add ref?*** cross-validation (3 splits) procedure was used.
...
exceeds $(0.5 \times {\rm DM}_{\textrm{opt}}, 1.5 \times {\rm DM}_{\textrm{opt}})$, then the
