...
Duncan Lorimer$^{5,6}$, Mayuresh Surnis$^{5,6}$, 
\and Golnoosh Golpayegani$^{5,6}$, Dan Werthimer$^{2}$,
...
current FRB rate models, we expected to see at most two FRBs based
on the total observing time, telescope sensitivity and beam size. We discuss the
implications of this non-detection in the context of recent detections
...
rate with our survey.  We use a model \citep[see equation 9 of][]{2013MNRAS.436L...5L} which assumes
...
No new FRBs were found in our observations to date. ***MADE IT HERE****

The ALFABURST system will continue to run commensally with other ALFA projects,
leading to an improvement on the event rate limits of low-fluence \glspl{frb}.
