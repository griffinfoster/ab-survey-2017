...
The current system is setup to be reliably in use for all beam any time
\gls*{alfa} is active and in the correct receiver turret poistion.
...
% TODO: regenerate the sky coverage with coverage up to June 2017
...
%   * expected rates based on non-detection, observation time, and FRB standard candle model
