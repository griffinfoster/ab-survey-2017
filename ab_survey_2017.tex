...
around 600,000~Mpc$^3$. Based on this, we would expect, at the 99\% confidence level, to see at most two FRBs.
...
distance.  As short duration bursts, probably emanating from point-like
sources, they offer the unique opportunities to probe the inter-galactic medium
\citep[IGM;][]{2013ApJ...776..125M}, as pulsars do for the Galactic
interstellar medium.
...
pulses. At the time of writing, 25 \glspl{frb} have been reported \citep[for an
...
been detected with UTMOST \citep{2017MNRAS.468.3746C,atel10697,atel10867} and
ASKAP \citep{2017ApJ...841L..12B}.
...
% TODO:
% class descriptions, distribution
% model description:
%	raw features
%	reduced features
%	preprocessing
%	random forest with one vs rest multiclass
%	stratified k fold cross validation
%	hyper parameter search
%	confusion matrix
%	log-loss/cross entropy
% histogram: probability to class 9 true-positive
% top features
...
ALFABURST activities are supported by a National Science Foundation (NSF) award AST-1616042.
MAM was supported by NSF award number AST-1517003  and DRL were supported by NSF award number OIA-1458952.

G.F., D.H.M, A.S., D.W. acknowledge support from the Breakthrough Listen Initiative. Breakthrough Listen is managed by the Breakthrough Initiatives, sponsored by the Breakthrough Prize Foundation\footnote{breakthroughinitiatives.org}.
